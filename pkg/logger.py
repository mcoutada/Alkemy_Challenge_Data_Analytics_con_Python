...
def setup_applevel_logger(logger_name=APP_LOGGER_NAME,
    ...
    # sys.excepthook(*exc_info) prints out a given traceback and exception to sys.stderr
...
def log_unhandled_exception(in_logger, *in_exc_info):
    ...
    in_logger.critical("Uncaught exception", exc_info=(exc_type, exc_value, exc_traceback))
